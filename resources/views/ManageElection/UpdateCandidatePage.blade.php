    ...
    <div class="page-content">
        ...
        <div clas="container-fluid">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="Post"
                action="{{ route('election.update', $election->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="candidate_name" type="text" value="{{ $election->candidate_name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <input type="file" id="candidate_picture" type="file" name="candidate_picture" class="dropify"
                                                        data-height="500" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="candidate_course" value="{{ $election->candidate_course}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input"
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="candidate_year" value="{{ $election->candidate_year}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" type="text" name="candidate_manifesto">{{ $election->candidate_manifesto}}</textarea>
                                        </div>
                        ...
                        <button class="btn btn-gradient-primary px-4 float-right mt-0 mb-3"><i
                                class="mdi mdi-plus-circle-outline mr-2"></i>Edit candidate</button>
                    </div>
                    <!--end card-->
                </div>
                <!--end col-->
